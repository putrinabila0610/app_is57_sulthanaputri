...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        <div class="row mb-2">
        <div class="col-sm-6">
            <h1>Form Tambah Pengiriman</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Form Tambah Pengiriman</li>
            </ol>
        </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive p-0">
            <form class="form-horizontal" action="/pengiriman/store" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputPassword3" name="tgl_kirim">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
